                ...
                <form id="editProductForm" action="editSanPham" method="POST" enctype="multipart/form-data">
                    ...
                    <div class = "form-group " style = "display: none">
                        ...
                        <div class="form-group" >                               
                            ...
                            <input type="text" class="form-control" id="CongNgheBaoQuanThucPhamEdit" name="CongNgheBaoQuanThucPhamEdit">
                        </div>
                        ...
                        <div class="form-group" >                               
                            ...
                            <input type="text" class="form-control" id="TienIch3Edit" name="TienIch3Edit">
                        </div>
                    </div>
...
//  Lay the cha cua tung loai the theo tskt           
    ...
    function editProductModal(id, name, brand, price, quantity, image, categoryId, tskt) {
        $('#MaSPEdit').val(id);
//                console.log(id);
        $('#nameEdit').val(name);
        $('#brandEdit').val(brand);
        ...
        setTSKTdefault(tskt, categoryId);
...
//              Truyen tskt theo id
    ...
    function setTSKTdefault(tskt, categoryId) {
        // Xóa ký tự đầu và cuối để lấy phần bên trong dấu {}
        var innerStr = tskt.substring(tskt.indexOf("{") + 1, tskt.lastIndexOf("}"));
        
// Tách thành mảng các cặp biến và giá trị
        var pairs = innerStr.split(", ");
// Tạo đối tượng JavaScript và gán các biến và giá trị
        var obj = {};
        for (var i = 0; i < pairs.length; i++) {
            var pair = pairs[i].split("=");
            var variable = pair[0].trim();
            if( categoryId === 1 ){
                if( variable === "TienIch" ||  variable === "KichThuocKhoiLuong" )
                    variable += "1";
            }
            if( categoryId === 2 ){
                if( variable === "CongNgheTietKiemDien" ||  variable === "TienIch" )
                    variable += "2";
            }
            if( categoryId === 3 ){
                if( variable === "CongNgheTietKiemDien" ||  variable === "KichThuocKhoiLuong"  ||  variable === "TienIch" )
                    variable += "3";
            }
            variable+="Edit";
