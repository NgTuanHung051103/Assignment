...
<html>
    ...
    <body>
        <div class="container" id="TraLaiHant">
            <h2></h2>

            <!--1 ORDER-->
            <c:forEach var = "order" items = "${requestScope.list_orderTLH}">
                ...
                <c:forEach var = "orderdetail" items = "${requestScope.list_order_detailTLH}">
