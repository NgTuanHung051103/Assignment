...
<html lang="en">
    ...
    <head>
        ...
        <!--link cua datatableOrderCXN ( dua tren account.jsp)-->
            ...
            <jsp:include page="../../common/dashboard/sideBar.jsp" ></jsp:include>
                ...
                <div id="content-wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Breadcrumbs-->
                    <%--<jsp:include page="../../common/dashboard/breadcumbProduct.jsp" ></jsp:include>--%>
                    ...
                    <!-- DataTables Example -->
                    <jsp:include page="../../admin/dashboard/datatableOrderCXN.jsp"></jsp:include>
