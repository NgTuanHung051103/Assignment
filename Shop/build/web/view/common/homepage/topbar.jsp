<%-- 
    Document   : topbar
    Created on : Aug 22, 2023, 3:02:14 PM
    Author     : ptkng
--%>
        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center py-3 px-xl-5">
                <div class="col-lg-3 d-none d-lg-block">
                    <a href="${pageContext.request.contextPath}/list" class="text-decoration-none">
                ...
                <div class="col-lg-6 col-6 text-left">
                    <form action="search" method="GET">
                        <div class="input-group">
                            <input  name ="key" type="text" class="form-control" placeholder="Search for products">
